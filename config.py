...
# --- Настройки отображения заказов для ПОЛЬЗОВАТЕЛЕЙ ---
USER_ORDERS_PER_PAGE = int(os.getenv("USER_ORDERS_PER_PAGE", 5)) # Количество заказов на одной странице в пагинации для ПОЛЬЗОВАТЕЛЕЙ
