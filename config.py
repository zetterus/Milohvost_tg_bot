...
ORDER_FIELDS_CONFIG = [
    ...
    {
        "key": "full_name",
        "prompt": "Теперь введи своё <b>полное имя</b> (ФИО) 👤:",
    ...
    },
    {
        ...
        "prompt": "Укажи <b>адрес доставки</b> (город, улица, дом, квартира) 🏠:",
    ...
    {
        "key": "payment_method",
        "prompt": "Как ты предпочитаешь <b>оплатить заказ</b>? 💳",
    ...
    },
    {
        "key": "contact_phone",
        "prompt": (
            "Пожалуйста, введите ваш <b>контактный телефон</b> или нажмите кнопку ниже, чтобы отправить его автоматически. "
            "Формат: <code>+&lt;код страны&gt;&lt;номер&gt;</code> (например, <code>+380991234567</code>, <code>380998644567</code>, <code>80991238947</code> или <code>+12125550123</code>)."
        ),
    ...
    {
        "key": "delivery_notes",
        "prompt": "Если есть <b>примечания к доставке</b> (например, 'домофон 123'), напиши их. Если нет, можешь отправить `-` или `нет` 💬:",
